"""
V.A.U.L.T. - PAGE 6: KNOWLEDGE BASE
Run with:  streamlit run 6_knowledge_base.py
Requires knowledge_base.html to sit in the SAME folder as this script.
"""
...
st.set_page_config(
    page_title="V.A.U.L.T. // Knowledge Base",
    page_icon="📚",
    layout="wide",
...
st.markdown(
    ...
    <style>
        ...
        /* Stretch the embedded iframe to fill the actual browser window
           ...
           scrolling stays enabled below so if your knowledge base ever has more
...
HTML_FILE = Path(__file__).parent / "knowledge_base.html"
